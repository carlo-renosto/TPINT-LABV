...
<body>
	...
	<div>
		<h2 style="text-align: center;">Baja paciente</h2>
	</div>
	
	<form method="post" action="paciente_baja.html" onsubmit="confirmarEliminacion(event)">
		<input type="text" placeholder="DNI" required name="txtDni"></input>
	...
	<script>
		function confirmarEliminacion(event) {
	        if(!confirm("¿Esta seguro de que desea dar de baja este paciente?")) {
