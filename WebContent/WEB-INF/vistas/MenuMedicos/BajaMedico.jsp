...
<body>
	...
	<div>
		<h2 style="text-align: center;">Baja medico</h2>
	</div>
	
	<form method="post" action="medico_baja.html" onsubmit="confirmarEliminacion(event)">
		<input type="text" placeholder="Legajo" required name="txtLegajo"></input>
	...
	<script>
		function confirmarEliminacion(event) {
	        if(!confirm("¿Esta seguro de que desea dar de baja este medico?")) {
