...
<body>
	...
	<div>
		<h2 style="text-align: center;">Cancelar turno</h2>
	</div>
	
	<form method="post" action="turno_cancelar.html" onsubmit="confirmarEliminacion(event)">
		<input type="text" placeholder="ID" required name="txtTurno"></input>
	...
	<script>
		function confirmarEliminacion(event) {
	        if(!confirm("¿Esta seguro de que desea cancelar este turno?")) {
